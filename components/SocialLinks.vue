  ...
  <div class="flex items-center gap-3">
    <a
      ...
      class="
        ...
        text-on-surface-variant hover:text-brand-accent
        transition-colors duration-200
        text-body-md
      "
    >
      <span class="text-lg leading-none" v-html="link.icon" />
...
const links = [
  ...
  {
    name: '简书',
    url: 'https://www.jianshu.com/u/08fae46b1348',
